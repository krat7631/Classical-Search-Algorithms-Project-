...
def dfs(
    ...
    # Stack entries are (state, depth). Depth used for max_depth pruning.
    ...
    # Check time and expansion limits before each expansion (same order as BFS)
    while stack:
        ...
        # Do not expand successors beyond max_depth (this node still counts as expanded)
    ...
    # If we hit no other limit but had max_depth set, report depth_limit so caller knows why we stopped
